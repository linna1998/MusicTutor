...
public class InputPanel extends JPanel {
	...
	public InputPanel(){
		...
		JCheckBox checkbox = new JCheckBox("Microphone loopback", true);
		checkbox.setActionCommand("loopback");
		checkbox.addActionListener(setInput);
	...
	private ActionListener setInput = new ActionListener(){
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(arg0.getActionCommand().equals("loopback")){
				loopback=!loopback;
				InputPanel.this.firePropertyChange("loopback", loopback, !loopback);
			}
		}
	};
